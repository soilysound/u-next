...
export default function Article(props) {
	...
	return (
		<>
			...
			<div className="wrap article-body article-text" style={{ "--wrap-gap": "var(--gap-400)" }} dangerouslySetInnerHTML={{ __html: `${story.body}<p class="article-end supporting-text"><span>${story.snippet}</span> - <a href="#comments">add your comment below</a></p>` }} />
			...
			<h2 className="display-400 flex-grid wrap" style={{"--justify": "center"}} id="comments">Comments</h2>
